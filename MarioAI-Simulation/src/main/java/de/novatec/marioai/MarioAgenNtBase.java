 ...
 * needed to implement an MarioAgent.
 *
 * @author tj NovaTec GmbH
 */
abstract class MarioAgenNtBase implements IAgent {
	...
	/**
	 * Looking for {@link Tiles} in Mario's near is possible by the
	 * {@link Tiles} object.
	 * 
	...
	public void drawPath(List<Coords> coordinates, VisualizationComponent vis, LevelScene level, IEnvironment env,
			Graphics g) {
		this.coordinates = coordinates;
