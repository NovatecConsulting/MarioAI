...
public class LevelConfig{
	public static final LevelConfig Level1=new LevelConfig(797938204,256,4,LEVEL_TYPES.OVERGROUND);
	...
	public static final LevelConfig LevelCUSTOM1=new LevelConfig(12345678,256,4,LEVEL_TYPES.OVERGROUND,true,true,true,new int[]{0,10,1,0,0});
	...
	public static final LevelConfig LevelCUSTOM3=new LevelConfig(12345678,256,4,LEVEL_TYPES.OVERGROUND,false,false,false,new int[]{1,0,0,10,0});
