...
public class Art
{
    ...
    final static String img = curDir + "\\src\\main\\resources\\";
...
//        System.out.println(curDir);
        ...
        try {
            source = ImageIO.read(Thread.currentThread().getContextClassLoader().getResourceAsStream(imageName));
            //System.out.println("source: " + source);
        }
        catch (Exception e) {
            System.err.println("Could not read img: "+imageName+" through ResourceStream");
        }
